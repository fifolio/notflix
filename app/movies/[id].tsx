        ...
        <View>
          ...
          <View className='flex-col items-start justify-center mt-5 px-5'>
            ...
            <View className='flex flex-row justify-between w-1/2'>
              ...
              <MovieInfo label='Revenue' value={`$${movie?.revenue as number / 1_000_000} million`} />
            </View>

            <MovieInfo label='Production' value={movie?.production_companies?.map((p) => p.name).join(' - ') || 'N/A'} />
